...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="Escala">
        <fo:root>
            <fo:layout-master-set>
                <fo:simple-page-master master-name="A4-landscape" page-height="21.0cm" page-width="29.7cm" margin="2cm" margin-left="5.8cm" margin-top="4.1cm">
                    <fo:region-body/>
            ...
            <fo:page-sequence master-reference="A4-landscape">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:block>
                        <fo:inline padding-left="12mm" font-style="italic" font-size="10pt">
                            <xsl:value-of select="@nome" />
                        </fo:inline>
                    </fo:block>
                    </fo:block-container>
                    <fo:table table-layout="fixed" width="30%" font-size="8pt" text-align="center" display-align="center">
    ...
    <xsl:template name="tabela">
        ...
        <fo:table table-layout="fixed" width="100%" font-size="8pt" border-color="black" border-width="0.2mm" border-style="solid">
            <fo:table-column column-width="5mm"/>
            <fo:table-column column-width="5mm"/>
            <fo:table-column column-width="proportional-column-width(35)"/>
            <fo:table-header>
                <fo:table-cell number-columns-spanned="2">
                    <fo:block background-color="lightgray" border-width="0.1mm" border-style="solid" font-weight="bold">Data</fo:block>
                </fo:table-cell>
                <fo:table-cell>
                    <fo:block background-color="lightgray" border-width="0.1mm" border-style="solid" font-weight="bold">Irmãs</fo:block>
                </fo:table-cell>
            </fo:table-header>
            <fo:table-body>
                <fo:table-row>
