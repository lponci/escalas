        ...
        <fo:root>
            ...
            <fo:page-sequence master-reference="A4-landscape">
                <fo:flow flow-name="xsl-region-body">
                    ...
                    <fo:table table-layout="fixed" width="25%" font-size="8pt" text-align="center" display-align="center">
        ...
        <fo:table table-layout="fixed" width="100%" font-size="8pt" border-color="black" border-width="0.2mm" border-style="solid">
            ...
            <fo:table-body>
                <fo:table-row>
                    ...
                    <fo:table-cell>
                        <xsl:for-each select="$contexto/Dias/dia/string">
                    ...
                    <fo:table-cell>
                        <xsl:for-each select="$contexto/Dias/escalada/string">
                            <xsl:call-template name="tabelaRow">
